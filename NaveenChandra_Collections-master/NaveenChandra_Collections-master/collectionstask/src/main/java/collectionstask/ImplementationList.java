...
public class ImplementationList<Y> {
    int a_size = 0;
    private static final org.apache.logging.log4j.Logger naveen1 =LogManager.getLogger(Accessingclass.class);
   ...
   public void adding (Y val) {
    ...
    public Y getting(int pos) {
 	   ...
 	   catch(Exception r)
 	   {
 		   ...
 		   naveen1.info("Index was not present within the range: " + pos);
 		    }
